 ...
 * Loads .env once and exposes a validated config object so the rest
...
const env = {
  ...
  MONGODB_URI: required('MONGODB_URI', 'mongodb://127.0.0.1:27017/hireloop'),
  ...
  EMAIL_FROM: required('EMAIL_FROM', 'HireLoop <no-reply@hireloop.dev>'),

  MAX_RESUME_SIZE_MB: parseInt(required('MAX_RESUME_SIZE_MB', '5'), 10),
